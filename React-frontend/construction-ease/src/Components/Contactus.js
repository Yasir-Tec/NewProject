...
const ContactusComponent = () => {
  ...
  const send = async (e) => {
    ...
    try {
      ...
      alert("Send Successfully!!!.Your problem will be solved within 3 to 4 working days.");
      setFormData({
        name: '',
        email: '',
        mobile: '',
              ...
              Send message
							...
							<div className="col-lg-6 ">
								<div className="contact-gmap">
									<iframe
										src="https://www.google.com/maps/@18.53108,73.851997,331m/data=!3m1!1e3?hl=en-US&entry=ttu"
										width="100%"
										height="500"
										frameborder="0"
										style={{ border: "0" }}
